...
wtrig1: wtrig1.o cidbx.o cigiz.o cirec.o ciupd.o ciutl.o cifm1.o cifm2.o cifm3.o citrm.o ciutf8.o
	echo ld wtrig1..
	$(CC) -o wtrig1 wtrig1.o cidbx.o cigiz.o cirec.o ciupd.o ciutl.o cifm1.o cifm2.o cifm3.o citrm.o ciutf8.o $(CCLIBS)
