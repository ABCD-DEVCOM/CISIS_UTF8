...
decsex: decsex.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o ciutf8.o
	echo ld decsex..
	$(CC) -o decsex decsex.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o ciutf8.o $(CCLIBS)
