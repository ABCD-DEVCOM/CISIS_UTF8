...
/* #endif  CICPP   AOT 27/03/2001 */
...
#if UTF8
    p="CISISUNI Interface v6.0a";
    q="Copyright (c)BIREME/PAHO/EdS 2015. [http://wiki.bireme.org/en/index.php/CISIS]";
#else
    p="CISIS Interface v5.7f";
    q="Copyright (c)BIREME/PAHO 2015. [http://wiki.bireme.org/en/index.php/CISIS]";
#endif
  ...
  //q3="Copyright (c)BIREME/PAHO 2015. [http://bvsmodelo.bvsalud.org/php/level.php?lang=pt&component=28&item=1]";
    q3="Copyright (c)BIREME/PAHO 2015. [http://wiki.bireme.org/en/index.php/CISIS]";
