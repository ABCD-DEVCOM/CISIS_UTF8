...
decs9a: decs9a.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o ciutf8.o
	echo ld decs9a..
	$(CC) -o decs9a decs9a.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o ciutf8.o $(CCLIBS)
