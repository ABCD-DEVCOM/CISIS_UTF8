...
printf("\\fldloop=%d *p=%c",fldloop,*p); GETCHAR;
                ...
                if (check) {
#if UTF8
					char string_subfield_identifier[5];
					sprintf(string_subfield_identifier,"%c",sfldc);
					uppercase_utf8(string_subfield_identifier);
					c = string_subfield_identifier[0];
#else
