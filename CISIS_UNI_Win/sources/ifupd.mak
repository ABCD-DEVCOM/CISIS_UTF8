...
ifupd: ifupd.o cifm1.o cifm2.o cifm3.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciupi.o ciutl.o cifst.o ciifu.o ciutf8.o
	echo ld ifupd..
	$(CC) -o ifupd ifupd.o cifm1.o cifm2.o cifm3.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciupi.o ciutl.o cifst.o ciifu.o ciutf8.o $(CCLIBS)
