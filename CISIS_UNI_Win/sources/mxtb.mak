...
mxtb: mxtb.o cib71.o cib72.o cifm1.o cifm2.o cifm3.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o ciutf8.o
	echo ld mxtb..
	$(CC) -o mxtb mxtb.o cib71.o cib72.o cifm1.o cifm2.o cifm3.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o ciutf8.o $(CCLIBS)
