...
mxget: mxget.o cifm1.o cifm2.o cifm3.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o cicgi.o ciutf8.o
	echo ld mxget..
	$(CC) -o mxget mxget.o cifm1.o cifm2.o cifm3.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o cicgi.o ciutf8.o $(CCLIBS)
