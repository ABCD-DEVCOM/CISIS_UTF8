...
#if UTF8
extern STRUCT_ISISUCTAB_UTF8 isisuctab_utf8_latin[]; 
extern STRUCT_ISISACTAB_UTF8 isisactab_utf8_latin[];
#endif	// UTF8
...
#else
#if UTF8
	isisuctab_utf8 = &(isisuctab_utf8_latin[0]);
	isisactab_utf8 = &(isisactab_utf8_latin[0]);
#else
    // default is ansi
