...
echo mkdir  utl2          >>xmk.xsh
echo mkdir  utl2/linux64  >>xmk.xsh

#echo mkdir utl/linux64/isis      >mkisis_64.xsh
echo mkdir utl2/linux64/isis1660  >mkisis1660_64.xsh
...
#echo mkdir utl2/linux64/BigIsis   >mkBigIsis_64.xsh
...
./mx seq=xls "pft='sh -x mxmake64.xsh utl2/linux64/isis1660 'left(v1,size(v1)-4)' CIFFI=0 LIND=0 LIND4=0 ISISXL=1 ISISXL512=0  SIXTY_FOUR=1 _FILE_OFFSET_BITS=00 _LARGEFILE64_SOURCE=0'/" lw=0 now >>mkisis1660_64.xsh
...
#./mx seq=xls "pft='sh -x mxmake64.xsh utl2/linux64/BigIsis    'left(v1,size(v1)-4)' CIFFI=1 LIND=0 LIND4=0 ISISXL=1 ISISXL512=0 SIXTY_FOUR=1  _FILE_OFFSET_BITS=64 _LARGEFILE64_SOURCE=1 SUPERISIS=1'/" lw=0 now >>mkBigIsis_64.xsh
...
echo          cp utl2/linux64/isis1660/wxis wxis/linux64/isis1660        >>xmk.xsh
...
#echo          cp utl2/linux64/BigIsis/wxis wxis/linux64/BigIsis          >>xmk.xsh

echo           rm *.o                                                    >>xmk.xsh
echo "nohup time sh -x xmk.xsh &"
nohup time sh -x xmk.xsh &

echo "compilation mx/wxis 1660 in directory utl2 finished !!!"
exit
