...
wtrig2: wtrig2.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o cifm1.o cifm2.o cifm3.o ciutf8.o
	echo ld wtrig2..
	$(CC) -o wtrig2 wtrig2.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o cifm1.o cifm2.o cifm3.o ciutf8.o $(CCLIBS)
